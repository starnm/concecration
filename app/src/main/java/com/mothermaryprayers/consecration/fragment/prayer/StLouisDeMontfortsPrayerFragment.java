...
public class StLouisDeMontfortsPrayerFragment extends Fragment {


    public static Fragment newInstance() {
        StLouisDeMontfortsPrayerFragment fragment = new StLouisDeMontfortsPrayerFragment();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_st_louis_de_montford, container, false);
        return fragmentView;
    }
